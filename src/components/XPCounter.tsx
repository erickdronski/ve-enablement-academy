...
const levels = [
  { name: 'Beginner', min: 0, max: 199, color: '#666' },
  { name: 'Intermediate', min: 200, max: 599, color: '#00E6B9' },
  { name: 'Advanced', min: 600, max: 999, color: '#8B5CF6' },
  { name: 'Expert', min: 1000, max: 2000, color: '#FFD700' },
];
